...
T.SpinBox {
    ...
    down.indicator: Rectangle {
        x: control.mirrored ? parent.width - width - 1 : 1
        y: 1
        height: parent.height - 2
        implicitWidth: 40
        implicitHeight: 40
    ...
    background: Rectangle {
        ...
        // Added 1px border to match TextField styling. To revert to the Qt
        // default (no visible border), change border.width to 0 and
        // border.color to control.palette.button.
